    ...
    <div className="max-w-4xl mx-auto p-6 lg:p-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-lime-500 font-bold"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              {...register("excerpt")}
              rows={2}
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-lime-500 text-sm resize-none"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              {...register("content")}
              rows={10}
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-lime-500 text-sm leading-relaxed resize-none"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              {...register("coverImage")}
              placeholder="https://..."
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-lime-500 text-sm"
            />
          </div>
        ...
        <button
          ...
          className="w-full h-14 bg-slate-950 text-white rounded-2xl font-black uppercase tracking-widest hover:bg-lime-600 transition-all flex items-center justify-center gap-2 shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
        >
