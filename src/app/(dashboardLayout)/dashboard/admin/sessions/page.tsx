...
export default function ManageSessionsPage() {
  ...
  try {
    ...
    setSessions(sessions || []);  // ✅ already Session[], no unwrap needed
  } catch (error) {
                    ...
                    <div className="flex gap-2">
                      {isAdmin && (
                        <button
                          ...
                          className="p-2.5 rounded-xl border border-rose-100 text-rose-500 hover:bg-rose-50 hover:border-rose-200 transition-all"
