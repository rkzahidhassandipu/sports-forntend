...
function AdminTicketDrawer({
  ...
  const deleteMutation = useMutation({
    mutationFn: () => SupportService.deleteTicket(ticketId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["support", "admin", "all"] });
      onClose();
    },
            ...
            <div className="px-8 py-5 border-t border-slate-100 space-y-3">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2.5 border border-red-200 text-red-500 text-[10px] font-black rounded-xl hover:bg-red-50 transition-all disabled:opacity-40"
                >
