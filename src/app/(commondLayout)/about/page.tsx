    ...
    <div className="min-h-screen pt-20 pb-16">
      <div className="bg-brand-mid border-b border-brand-border py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="inline-block bg-[#9AD872]/10 text-[#9AD872] border border-[#9AD872]/30 px-3 py-1 rounded-full text-xs font-bold tracking-widest uppercase mb-4">About Us</span>
          <h1 className="font-display font-black text-5xl sm:text-6xl leading-tight mb-4">
            OUR <span className="text-[#9AD872]">STORY</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid lg:grid-cols-2 gap-14 mb-16">
          <div>
            <h2 className="font-display font-black text-4xl mb-5">OUR <span className="text-[#9AD872]">MISSION</span></h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={s.label} className="bg-brand-mid border border-brand-border rounded-xl p-6 text-center hover:border-[#9AD872]/30 transition-colors">
                <div className="font-display font-black text-4xl text-[#9AD872] mb-2">{s.num}</div>
        ...
        <div>
          <h2 className="font-display font-black text-4xl mb-8">MEET THE <span className="text-[#9AD872]">COACHES</span></h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={coach.name} className="bg-brand-mid border border-brand-border rounded-xl p-6 text-center hover:border-[#9AD872]/30 transition-all duration-200 hover:-translate-y-1">
