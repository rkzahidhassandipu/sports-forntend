      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display font-black text-[clamp(36px,5vw,56px)] leading-tight mb-4">
            WHY SPORT<span className="text-lime-500">PULSE</span>?
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className="group relative bg-brand-card border border-brand-border rounded-xl p-6 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-lime-500/30 hover:shadow-lg hover:shadow-lime-500/5"
            >
              ...
              <div className="w-11 h-11 rounded-xl bg-lime-500/10 border border-lime-500/20 flex items-center justify-center text-xl mb-5">
                {f.icon}
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display font-black text-[clamp(36px,5vw,56px)] leading-tight">
            CHOOSE YOUR<br /><span className="text-lime-500">SPORT</span>
          </h2>
        </div>
          ...
          {SPORTS_CATEGORIES.map((cat) => (
            <Link
              ...
              className={cn(
                ...
                active === cat.name
                  ? "bg-gradient-to-br from-lime-500/15 to-teal-500/8 border-lime-500/40 shadow-lg shadow-lime-500/10"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
          <div>
            ...
            <h2 className="font-display font-black text-[clamp(36px,5vw,56px)] leading-tight">
              POPULAR<br /><span className="text-lime-500">SESSIONS</span>
            </h2>
          </div>
          <Link href="/sessions" className="border border-brand-border text-muted-foreground font-display font-bold text-sm px-5 py-2.5 rounded-xl hover:border-lime-500/50 hover:text-lime-500 transition-all duration-200 tracking-wide">
            VIEW ALL →
          </Link>
        </div>
    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {STATS.map((s) => (
            <div key={s.label} className="text-center p-6 bg-brand-mid border border-brand-border rounded-xl hover:border-lime-500/30 transition-colors duration-200">
              <div className="text-3xl mb-3">{s.icon}</div>
              <div className="font-display font-black text-4xl text-lime-500 leading-tight mb-1">{s.num}</div>
    ...
    <section className="py-20 bg-brand-mid">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="font-display font-black text-[clamp(36px,5vw,56px)] leading-tight">
            EXCLUSIVE<br /><span className="text-lime-500">DEALS</span>
          </h2>
        </div>
        <div className="grid sm:grid-cols-3 gap-5">
          {OFFERS.map((o) => (
            <div key={o.title} className={cn(
              ...
              o.color === "lime" && "bg-lime-500/8 border-lime-500/25",
  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t) => (
            <div key={t.name} className="bg-brand-mid border border-brand-border rounded-xl p-6 hover:border-lime-500/20 transition-colors duration-200">
            ...
            <div key={i} className="bg-brand-card border border-brand-border rounded-xl overflow-hidden">
              ...
              >
                ...
                <span className={cn(
                  ...
                  open === i && "rotate-45 text-lime-500"
                )}>+</span>
              </button>
              <div className={cn(
...
export function NewsletterSection() {
  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center bg-gradient-to-br from-lime-500/8 to-teal-500/5 border border-lime-500/15 rounded-2xl p-12">
          <SectionTag>Newsletter</SectionTag>
          <h2 className="font-display font-black text-[clamp(32px,5vw,48px)] leading-tight mb-4">
            STAY IN THE<br /><span className="text-lime-500">GAME</span>
          </h2>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex gap-2 max-w-sm mx-auto flex-wrap sm:flex-nowrap">
              <input
                ...
                required
                className="flex-1 min-w-0 bg-brand-card border border-brand-border text-foreground placeholder:text-muted-foreground/50 rounded-xl px-4 py-3 text-sm outline-none focus:border-lime-500 transition-colors"
              />
              <button
                type="submit"
                className="bg-lime-500 text-brand-dark font-display font-bold px-5 py-3 rounded-xl hover:bg-lime-400 transition-all duration-200 active:scale-95 text-sm tracking-wide whitespace-nowrap"
              >
                SUBSCRIBE
              </button>
            </form>
