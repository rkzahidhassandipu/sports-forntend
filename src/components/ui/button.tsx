  ...
  return (
    <button
      className={cn(
        ...
        {
          "bg-[#9AD872] text-brand-dark hover:bg-lime-400 active:scale-95": variant === "primary",
          "border border-brand-border text-foreground hover:border-[#9AD872] hover:text-[#9AD872] bg-transparent": variant === "outline",
