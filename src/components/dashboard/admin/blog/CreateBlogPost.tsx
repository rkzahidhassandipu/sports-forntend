      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-10 lg:inset-20 bg-[#162513] z-[101] rounded-[2.5rem] shadow-2xl overflow-hidden md:w-3/5 lg:w-2/5 flex flex-col mx-auto"
          >
            {/* Top Bar */}
            <div className="flex items-center justify-between px-8 py-6 border-b border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#9AD872] rounded-full flex items-center justify-center text-[#f0f7ec]">
              ...
              >
                <X size={24} className="text-[#7a9c6e]" />
              </button>
            </div>
            ...
            >
              <div className="space-y-8">
                ...
                <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-[#7a9c6e] flex items-center gap-2">
                      <Send size={12} /> Brief Summary
                    </label>
                    <textarea
                      {...register("excerpt")}
                      className="w-full h-20 p-4 bg-[#162513] border border-slate-200 rounded-2xl text-xs outline-none focus:border-[#9AD872]"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      {...register("coverImage")}
                      className="w-full p-4 bg-[#162513] border border-slate-200 rounded-2xl text-xs outline-none focus:border-[#9AD872]"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      {tags.map((t, i) => (
                        <span
                          key={i}
                          className="flex items-center gap-1 px-2 py-1 bg-[#162513] border border-slate-200 rounded-md text-[10px] font-bold"
                        >
                          #{t}
                          <X
                            size={10}
            ...
            <div className="p-6 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-xs font-bold text-[#7a9c6e]">
                  Publish immediately
                </span>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={handleInternalClose}
                  className="px-6 py-3 text-xs font-bold uppercase tracking-widest text-[#7a9c6e] hover:text-[#7a9c6e]"
                >
                  Discard
                </button>
                <button
                  ...
                  className="flex items-center gap-2 px-8 py-3 bg-slate-900 text-[#f0f7ec] rounded-2xl text-xs font-bold uppercase tracking-widest hover:bg-lime-600 transition-all shadow-lg disabled:opacity-50"
                >
                  {mutation.isPending && (
